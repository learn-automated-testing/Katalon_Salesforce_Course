...
for (int i = 1; i <= rowCount; i++) {
    ...
    WebUI.waitForElementClickable(findTestObject('Salesforce/Account/Masterdata_fields_Pageobjects/combofields', [('comboboxitem') : typeOfAccount]), 
        20)

    WebUI.click(findTestObject('Salesforce/Account/Masterdata_fields_Pageobjects/combofields', [('comboboxitem') : typeOfAccount]))
